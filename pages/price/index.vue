<template>
  <section>
    ...
    <section class="section price-size content">
      ...
      >
        <div class="price columns">
          ...
          <div class="column is-4 p-price">{{ p.price }}</div>
        </div>
      </div>
    </section>
    ...
    <section class="section price-footer content">
      <ul>
        <li>
          料⾦表はあくまで⽬安の⾦額です。 実際にはデザイン内容（細かさ等）によって異なります。 デザイン打ち合わせ時に⼤体の⾦額をお伝え致しますが、 サイズや変更点を後の打ち合わせ調整後、デザイン決定してから確定いたします。
        </li>
        <li>
          A5サイズより⼤きいサイズや、2⽇以上時間のかかるデザインの場合、当店の判断で、時間制とさせていただきます。
        </li>
        <li>
...
export default class Price extends Vue{
  ...
  sizePrices = [
    {
      name: 'コインサイズ',
      desc: '極めて細かいデザイン等、例外もございます。',
      price: '￥10,000〜'
    },
    {
      name: '名刺サイズ',
      desc: '一般的な名刺の中に収まるものを指します。',
      price: '￥15,000〜'
    },
    {
      name: 'スマートフォン(ハガキ)サイズ',
      desc: '',
      price: '￥30,000〜'
    },
    {
